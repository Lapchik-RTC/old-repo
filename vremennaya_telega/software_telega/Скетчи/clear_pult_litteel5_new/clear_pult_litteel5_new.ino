...
ch = analogRead(A7);
  ...
  if (digitalRead(baton3) == 1 && MicroBotn == 2) {
    while (digitalRead(baton3) == 1) {}
    MicroBotn = 0;
  }
  ...
  Y4 = analogRead(axis_Y2);
  map(Y4, 0, 1023, -255, 255);
...
void sendmotors3(int X1, int Y1) {
  int speed1 = 0;
  int speed2 = 0;
  //int speedValue = analogRead(A9);
  lcd.setCursor(11, 0);
